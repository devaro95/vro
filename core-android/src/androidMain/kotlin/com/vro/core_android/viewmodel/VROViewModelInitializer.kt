...
fun <S : VROState, D : VRODestination, E : VROEvent> initializeViewModel(
    ...
    val vm = ViewModelProvider(activity, vroFactory)[viewModelSeed.id, VROAndroidViewModel::class.java]
...
fun <S : VROState, D : VRODestination, E : VROEvent> initializeViewModel(
    ...
    val vroFactory = VROViewModelFactory(viewModelSeed)
    val vm = ViewModelProvider(fragment, vroFactory)[viewModelSeed.id, VROAndroidViewModel::class.java]
    return vm as VROAndroidViewModel<S, D, E>
}
...
fun <S : VROState, D : VRODestination, E : VROEvent> initializeViewModel(
    ...
    val vm = ViewModelProvider(dialogFragment, vroFactory)[viewModelSeed.id, VROAndroidViewModel::class.java]
    return vm as VROAndroidViewModel<S, D, E>
}
