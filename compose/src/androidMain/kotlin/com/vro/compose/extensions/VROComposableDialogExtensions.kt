...
fun <VM : VRODialogViewModel<S, E>, S : VROState, E : VROEvent> VROComposableDialog(
    ...
    VroComposableDialogContent(viewModel = viewModel(), content = content, onDismiss = onDismiss, listener = listener)
}
...
private fun <VM : VRODialogViewModel<S, E>, S : VROState, E : VROEvent> VroComposableDialogContent(
    ...
    if (stepper is VROStepper.VROSkeletonStep) content.ComposableDialogSkeleton()
    else {
